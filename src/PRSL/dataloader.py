...
from simple_dataloader import SimpleDataset, collect_sim_paths, get_sims, min_max_normalize, compute_climatology, get_coords
...
class PRSLDataset(SimpleDataset):
    def __init__(
        self,
        data_path,
        cr_list,
